...
from flaskblog.users.users_forms import (RegistrationForm, LoginForm, AccountUpdateForm,
...
def reset_token(token):
    ...
    if user is None:
        flash ('That is a invalid Token','warning')
...
def user(user_id):
    ...
    return render_template('delete_user.html',title=user.email,user=user)
